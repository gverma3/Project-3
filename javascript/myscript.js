...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 function ChekList(chk)
    {
        var checkList = chk.parentNode.parentNode.parentNode;
        var checks = checkList.getElementsByTagName("input");
        for(var i=13;i<checks.length;i++)
        {
            if(checks[i] != chk && chk.checked)
            {
                checks[i].checked=false;
            }
        }
...
// Main function checks for valid input from all fields.
 ...
 function validateFirstname(errMessages) {
       ...
       if (stringLength === 0) { 
           ...
           if (stringLength < 3) {
               ...
               if (problem == 4) {
                   errMessages +="<li><mark>Firstname</mark><br /> Only alphabetic characters are allowed(optional Hyphen(-) <mark>only one</mark>anywhere after 3rd field but not at the end)<br />" + "</li>";
               }
	       else if (problem == 1) {
                   errMessages +="<li><mark>Firstname</mark><br /> Hyphen is not allowed at the end.<br />" + "</li>";
               }
	       else if (problem == 2) {
                   errMessages +="<li><mark>Firstname</mark><br /> Hyphen is allowed only once.<br />" + "</li>";
               }
	       else if (problem == 3) {
                   errMessages +="<li><mark>Firstname</mark><br /> Only alphabetic characters are allowed in first 3 fields.<br />" + "</li>";
               }	
           }
       } 
	   if(errMessages == ""){
		   document.application.fName.value = stringName.toUpperCase();
	   }
       return errMessages;
     }  //  End of function
       ...
       if (stringLength === 0) { 
           errMessages += "<li><mark>Surname</mark><br /> The surname field can not be left empty or just blank characters<br />" + "</li>";
			  ...
			  for (var j=4;j<stringLength;j++ ) {
               ...
               if  (problem == 4) {
                   errMessages +="<li><mark>Surname</mark><br /> Only alphabetic characters are allowed for the surname(optional hyphen(-) or/and apostrophe(') <mark>only once</mark>, but not at the end nor together.<br />" + "</li>";
               }
	       else if  (problem == 1) {
                   errMessages +="<li><mark>Surname</mark><br /> Hyphen or apostrophe are not allowed at the end.<br />" + "</li>";
               }
	       else if  (problem == 2) {
                   errMessages +="<li><mark>Surname</mark><br /> Hyphen and apostrophe are not allowed next to each other.<br />" + "</li>";
               }
	       else if  (problem == 3) {
                   errMessages +="<li><mark>Surname</mark><br /> Only alphabetic characters are allowed in the first four fields.<br />" + "</li>";
               }
           }        
         if(errMessages == ""){
		   document.application.sName.value = stringName.toUpperCase();
	   }
	  return errMessages;
     }  //  End of function
...
// Email validator.
 ...
 function validateEmail(errMessages) {       
       ...
       if (stringLength === 0) { 
           errMessages += "<li><mark>Email</mark><br /> The email field can not be left empty or just blank characters<br />" + "</li>";
	   ...
	   else if((stringName.charCodeAt(stringLength - 1) === 46) || (stringName.charCodeAt(stringLength - 1) === 64)){
			errMessages += "<li><mark>Email</mark><br /> Charcters (@) or (.) cannot be at the end nor in the beginning.<br />" + "</li>";   
	        ...
	        if(Q != -1 || P != -1){
		        if((p != P) || (q != Q) || (q + 1 === p) || (p + 1 === q)){				
				    errMessages += "<li><mark>Email</mark><br /> Charcters (@) and (.) cannot be typed twice or beside each other.<br />" + "</li>";	 					
		        }
		    }
		}
            ...
            if  (problem == 3) {
				...
				errMessages += "<li><mark>Email</mark><br /> In the first part of the email there are blanks or not enough characters(Minimum 3).<br />" + "</li>";		
			}
			else if(problem == 12){
				errMessages += "<li><mark>Email</mark><br /> In the first part of the email there are invalid characters.(No special characters or ('@' or '.'))<br />" + "</li>";		
			}			
			else if(problem == 8){
				errMessages += "<li><mark>Email</mark><br /> In the second part of the email there are blanks or not enough characters(Minimum 3).<br />" + "</li>";		
			}
			else if(problem == 13){
				errMessages += "<li><mark>Email</mark><br /> In the second part of the email there are invalid characters.(No special characters or ('@' or '.'))<br />" + "</li>";		
			}			
           }     
 ...
 function validatePhone(errMessages) {
       ...
       if (stringLength === 0) { 
           errMessages += "<li><mark>Phone No.</mark><br /> The field can not be left empty or just blank characters.<br />" + "</li>";
			   ...
			   var part3 = stringName.substr(8,4);
			   var pt1 = 416;
			   var pt2 = 647;
			   			   
			   if((part1 == pt1) || (part1 == pt2)){				   
					problem = 0;
			   }else{
				   problem = 4;
			   }		
	 ...
	 function validateApt(errMessages) {       
       ...
       if (stringLength === 0) { 
           problem = 0;
            ...
            if(problem){
                   errMessages +="<li><mark>Apt</mark><br /> Atleast an alphabet or a number in this field.<br />" + "</li>";
            }
        } 
...
// Year at current location validator.
 ...
 function validateIncome(errMessages) {	       
       ...
       if (stringLength === 0) { 
           errMessages += "<li><mark>Monthly Income</mark><br /> The field can not be left empty or just blank characters<br />" + "</li>";
			   ...
			   if(stringName1 != "" && (stringName1 > 200)){
       ...
       if (stringLength === 0) { 
           errMessages += "<li><mark>Postal Code</mark><br /> The postal field can not be left empty or just blank characters<br />" + "</li>";
              ...
              if(problem == 9){
                   ...
                   errMessages +="<li><mark>Postal Code</mark><br /> Only space can be used only once." + nameMessageRules +"</li>";
              }			  
           }        
...
// Provine, postal code relation validator.
 ...
 function validateprovRelPCode(errMessages) {
		 ...
		 if(errMessages1 === errMessages2){
			 ...
			 var stringName2 = document.application.province.value;  
				...
				else if(stringName2 === "Ontario"){
					if(stringName1.charCodeAt(0) == 72){
						problem++;
					}
				}				
...
// Prints the errors on the screen.
