...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 function validateEmail(errMessages) {       
       ...
       if (stringLength < 10) { 
           errMessages += "<li><mark>Email</mark><br /> The number of characters you entered are not enough for email.<br />" + "</li>";
       }
            ...
            if  (problem == 3) {
				...
				errMessages += "<li><mark>Email</mark><br /> In the first part of the email there are blank or no valid characters.<br />" + "</li>";		
			}
			else if(problem == 12){
				errMessages += "<li><mark>Email</mark><br /> In the first part of the email there are invalid characters.<br />" + "</li>";		
			}			
			else if(problem == 8){
				errMessages += "<li><mark>Email</mark><br /> In the second part of the email there are blank or no valid characters.<br />" + "</li>";		
			}
			else if(problem == 13){
				errMessages += "<li><mark>Email</mark><br /> In the second part of the email there are invalid characters.<br />" + "</li>";		
			}			
           }     
